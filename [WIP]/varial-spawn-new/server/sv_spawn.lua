...
RegisterServerEvent("varial-login:disconnectPlayer")
AddEventHandler("varial-login:disconnectPlayer", function()
    local src = source
    DropPlayer(src, "You DisConnected")
end)

RegisterServerEvent("varial-base:playerSessionStarted")
...
AddEventHandler("srp-spawn:licenses", function()
    ...
    exports.oxmysql:execute("INSERT INTO user_licenses (type, owner) VALUES (@type, @owner)", {['@type'] = "Driver",['@owner'] = char.id})
