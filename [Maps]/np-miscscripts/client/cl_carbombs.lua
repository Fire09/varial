...
--   exports['varial-sync']:SyncedExecution('NetworkExplodeVehicle', pEntity, 1, 0, 0)
--   TriggerServerEvent('varial-miscscripts:carbombs:removeBomb', NetworkGetNetworkIdFromEntity(pEntity))
-- end
...
--   local progress = exports['varial-taskbar']:taskBar(25000, 'Searching for car bomb...', true)
--   ClearPedTasks(PlayerPedId())

--   if progress ~= 100 then return end

--   local metaData = exports['varial-vehicles']:GetVehicleMetadata(pEntity)
--   local carBombMeta = metaData.carBombData or false

--   if carBombMeta and carBombMeta.hasCarBomb then
--     TriggerServerEvent('varial-miscscripts:carbombs:foundBomb', NetworkGetNetworkIdFromEntity(pEntity), carBombMeta)
...
--   local progress = exports['varial-taskbar']:taskBar(25000, 'Planting car bomb...', true)
...
--   local added = NPX.Procedures.execute('varial-miscscripts:carbombs:addCarBomb', netId, minSpeed, ticksBeforeExplode, ticksForRemoval, gridSize, coloredSquares, timeToComplete)
--   TriggerEvent('inventory:removeItem', 'car_bomb', 1)
  
--   return TriggerEvent('DoLongHudText', 'Successfully added car bomb to vehicle', 1)
-- end)

-- AddEventHandler('varial-miscscripts:carBombs:removeBomb', function (pData, pEntity)
--   local metaData = exports['varial-vehicles']:GetVehicleMetadata(pEntity)
--   local carBombMeta = metaData.carBombData or false
...
--       gameFinishedEndpoint = 'varial-miscscripts:carBombs:completeHacking',
...
-- RegisterUICallback('varial-miscscripts:carBombs:completeHacking', function(data, cb)
...
--   TriggerServerEvent('varial-miscscripts:carbombs:removeBomb', netId)
