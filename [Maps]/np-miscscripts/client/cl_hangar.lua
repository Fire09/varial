...
local function handleKeyPress(pZone, pData)
    ...
    if not exports["varial-business"]:IsEmployedAt("ron_corp") then
        return
    end
...
AddEventHandler("varial-polyzone:enter", function(pZone, pData)
...
AddEventHandler("varial-polyzone:exit", function(pZone, pData)
    if pZone ~= "unknown_location" then
        return
    end
...
CreateThread(function()
    exports["varial-polyzone"]:AddBoxZone("unknown_location", vector3(-1143.99, -3396.62, 47.85), 34.4, 21.8, {
        heading = 330,
        minZ = 12.8,
        maxZ = 29.4,
        data = {
    ...
    exports["varial-polyzone"]:AddBoxZone("unknown_location", vector3(-1266.85, -3012.09, -48.49), 35.2, 29.0, {
        heading = 0,
        minZ = -49.49,
        maxZ = -35.29,
        data = {
    ...
    exports["varial-polyzone"]:AddBoxZone("unknown_location", vector3(-1238.71, -3059.8, -48.49), 19.8, 10, {
        heading = 0,
        minZ = -49.49,
        maxZ = -41.09,
        data = {
    ...
    exports["varial-polyzone"]:AddBoxZone("unknown_location", vector3(-1221.13, -2985.22, -48.49), 5, 5, {
        heading = 0,
        minZ = -49.49,
        maxZ = -45.49,
        data = {
    ...
    exports["varial-polyzone"]:AddBoxZone("unknown_location", vector3(-1219.85, -3490.28, 13.94), 2.4, 2.6, {
        heading = 330,
        minZ = 12.94,
        maxZ = 15.34,
        data = {
