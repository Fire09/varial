...
AddEventHandler('casino:enter', function()
  if exports['isPed']:isPed("myjob") == "casino_dealer" then
    ...
    TriggerEvent("DoLongHudText","The casino isn't open yet", 2)
  end
end)
...
AddEventHandler('penthouse:enter', function()
	...
	local waiting = exports['varial-taskbar']:taskBar(5000, 'Waiting')
	if waiting == 100 then 
