...
function LeaveBed()
    ...
    TriggerServerEvent('varial-hospital:server:LeaveBed', bedOccupying)
...
RegisterNetEvent('varial-hospital:client:RPCheckPos')
AddEventHandler('varial-hospital:client:RPCheckPos', function()
    TriggerServerEvent('varial-hospital:server:RPRequestBed', GetEntityCoords(PlayerPedId()))
end)

RegisterNetEvent('varial-hospital:client:RPSendToBed')
AddEventHandler('varial-hospital:client:RPSendToBed', function(id, data)
    bedOccupying = id
...
RegisterNetEvent('varial-hospital:client:SendToBed')
AddEventHandler('varial-hospital:client:SendToBed', function(id, data)
    bedOccupying = id
    bedOccupyingData = data
    ...
    Citizen.CreateThread(function ()
        ...
        TriggerServerEvent('varial-hospital:server:EnteredBed')
    end)
end)

RegisterNetEvent('varial-hospital:client:FinishServices')
AddEventHandler('varial-hospital:client:FinishServices', function()
