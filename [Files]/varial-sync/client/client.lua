TriggerServerEvent("drp:sync:player:ready")
...
function syncNative(name, netEntity, options, ...)
    TriggerServerEvent("varial-sync:executeSyncNative", name, netEntity, options, table.pack(...))
end
exports("syncNative", syncNative)

RegisterNetEvent("varial-sync:clientExecuteSyncNative")
AddEventHandler("varial-sync:clientExecuteSyncNative", function(native, netEntity, options, args)
