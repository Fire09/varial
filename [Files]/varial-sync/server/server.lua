...
RegisterServerEvent("varial-sync:executeSyncNative")
AddEventHandler("varial-sync:executeSyncNative",function(name, netEntity, options, args)
    TriggerClientEvent("varial-sync:clientExecuteSyncNative",-1,name, netEntity, options, args)
end)