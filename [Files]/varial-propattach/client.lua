...
Citizen.CreateThread(function()
  exports["varial-binds"]:registerKeyMapping("", "Player", "Drop Prop", "+propAttachDrop", "-propAttachDrop")
...
attachPropList = {
	...
	["cane"] = {
		["model"] = "prop_cs_walking_stick", ["bone"] = 28422, ["x"] = 0.1,["y"] = 0.0,["z"] = 0.0,["xR"] = -5.0,["yR"] = -90.0, ["zR"] = 0.0
	},
...
RegisterNetEvent('varial-propattach:attach')
AddEventHandler('varial-propattach:attach', function(pPropItem, pTargetFunction)
...
RegisterNetEvent('attach:cane')
AddEventHandler('attach:cane', function()
	TriggerEvent("attachItemPerm","cane")
end)
...
local Objects = {
    { ["x"] = 146.62, ["y"] = -3014.06, ["z"] = 6.95, ["h"] = 181.0, ["model"] = "prop_till_01" },

    { ["x"] = 148.07, ["y"] = -3014.12, ["z"] = 6.95, ["h"] = 181.0, ["model"] = "prop_cs_silver_tray" },

}

-- --Name: mintyy | 2022-06-02T22:23:15Z
-- BoxZone:Create(vector3(146.62, -3014.06, 7.04), 0.5, 0.5, {
--     name="mintyy",
--     heading=0,
--     --debugPoly=true
--   })
