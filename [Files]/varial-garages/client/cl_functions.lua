...
function SpawnVehicle(vehicle, pGarage, Fuel, customized, plate, IsViewing)
    ...
    elseif exports['varial-menu']:houseGarageCoords() ~= nil and exports['varial-menu']:NearHouseGarage() then
        HousingSpawn = exports['varial-menu']:houseGarageCoords()
	...
	Citizen.CreateThread(function()			
        ...
        if not IsViewing then    
            CurrentDisplayVehicle = nil
            RPC.execute("varial-garages:states", "Out", plate, exports['varial-menu']:currentGarage())
        end
    end)
end
