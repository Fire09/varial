...
function Void.SettingsData.setSettingsTable(settingsTable, shouldSend)
  if settingsTable == nil then
    ...
    TriggerServerEvent('varial-base:sv:player_settings_set',Void.Settings.Current)
...
RegisterNetEvent("varial-base:cl:player_settings")
AddEventHandler("varial-base:cl:player_settings", function(settingsTable)
  Void.SettingsData.setSettingsTable(settingsTable,false)
end)


RegisterNetEvent("varial-base:cl:player_reset")
AddEventHandler("varial-base:cl:player_reset", function(tableName)
