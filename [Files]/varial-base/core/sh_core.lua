...
RegisterNetEvent("varial-base:consoleLog")
AddEventHandler("varial-base:consoleLog", function(msg, mod)
...
-- RegisterNetEvent('varial-mdt:delreport')
-- AddEventHandler('varial-mdt:delreport', function()
--     local src = source
--     local user = exports["varial-base"]:getModule("Player"):GetUser(src)
...
-- RegisterNetEvent('varial-mdt:delwarrant')
-- AddEventHandler('varial-mdt:delwarrant', function()
--     local src = source
--     local user = exports["varial-base"]:getModule("Player"):GetUser(src)
--     local char = user:getCurrentCharacter()
--     local hexId = user:getVar("hexid")
