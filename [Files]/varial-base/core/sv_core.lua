...
function Void.Core.ConsoleLog(self, msg, mod, ply)
	...
	if ply and tonumber(ply) then
		TriggerClientEvent("varial-base:consoleLog", ply, msg, mod)
	end
end

AddEventHandler("onResourceStart", function(resource)
	TriggerClientEvent("varial-base:waitForExports", -1)
...
RegisterNetEvent("varial-base:playerSessionStarted")
...
Citizen.CreateThread(function()
	while true do
		...
		print("^1[varial-base] Paychecks Sent^0")
	end
end)
