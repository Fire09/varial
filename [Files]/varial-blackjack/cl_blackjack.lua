...
cfg.blackjackTables = {
    --[id] = {x,y,z,heading}
    [0] = {
        dealerPos = vector3(1043.684, 56.02, 69.1),
        dealerHeading = 46.0,
        tablePos = vector3(1043.684, 56.02, 69.1),
        tableHeading = 203.9,
        distance = 1000.0,
        prop = "vw_prop_casino_blckjack_01"
    },
    [1] = {
        dealerPos = vector3(1036.098, 54.20203, 69.06012),
        dealerHeading = 12.43,
        tablePos = vector3(1035.955, 54.80, 68),
        tableHeading = 45.31,
        distance = 1000.0,
        prop = "vw_prop_casino_blckjack_01"
    },
    ...
    -- },
    [4] = {
        dealerPos = vector3(1036.623, 51.71506, 69.06012),
        dealerHeading = 189.2   ,
        tablePos = vector3(1036.802, 50.84061, 69.53187),
        tableHeading = 199.4,
        distance = 1000.0,
        prop = "vw_prop_casino_blckjack_01b"
    },
    [5] = {
        dealerPos = vector3(1044.132, 53.69385, 69.06012),
        dealerHeading = 189.6,
        tablePos = vector3(1044.333, 53.00134, 69.25938),
        tableHeading = 191.1,
        distance = 1000.0,
        prop = "vw_prop_casino_blckjack_01b"
    },  
            ...
            if closestChair ~= nil and closestChairDist < 2 then
                if not timeoutHowToBlackjack then
                    if blackjackTableData[closestChair] == false then 
                        if exports['varial-inventory']:hasEnoughOfItem('casinomember', 1) then
                        exports["varial-interaction"]:showInteraction("Press [E] to play blackjack", 'info')
                        Citizen.Wait(3000)
                        exports["varial-interaction"]:hideInteraction()
                    else 
                       
                        exports["varial-interaction"]:showInteraction("This seat is taken or you do not have a membership", 'danger')
                        Citizen.Wait(3000)
                        exports["varial-interaction"]:hideInteraction()
                    end
...
Citizen.CreateThread(function()
    while true do 
        ...
        if drawCurrentHand then 
            ...
            exports["varial-interaction"]:showInteraction("Your hand is["..tostring(currentHand).."], the dealers hand is ["..tostring(dealersHand).."]")
...
AddEventHandler("Blackjack:beginBetsBlackjack",function(gameID,tableId)
    ...
    Citizen.CreateThread(function()
        ...
        if not bettedThisRound then
            ...
            TriggerEvent("varial-context:closemenu")
        end
    end)
    end
end)
...
AddEventHandler("betmenu", function()
    local tmpInput = exports["varial-applications"]:KeyboardInput({
        header = "Bet Ammount",
        rows = {
        {
            id = 1,
    ...
    TriggerEvent('varial-context:sendMenu', {
        {
            id = 1,
            header = "Hit me!",
			txt = "Try your luck with another card",
			params = {
                event = "hitcasino"
            }
        },
...
AddEventHandler("Blackjack:blackjackWin",function(tableId)
    if closeToCasino then
        ...
        happyIWon()
        canExitBlackjack = true
        drawNativeNotification("You win!")
        drawCurrentHand = false
        currentHand = 0
        dealersHand = 0
    end
