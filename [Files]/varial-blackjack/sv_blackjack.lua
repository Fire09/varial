...
AddEventHandler("Blackjack:requestSitAtBlackjackTable", function(chairId)
    ...
    if source ~= nil then
        ...
        TriggerClientEvent("DoLongHudText",source,"~r~Error, can't sit you down.", 2)
            ...
            if tonumber(betAmount) then
                ...
                if betAmount > 0 then
                    if tryTakeChips(source,betAmount) then
                        ...
                        TriggerClientEvent("DoLongHudText",source,"Bet placed: " .. tostring(betAmount) .. " chips.", 1)
                    else 
                        TriggerClientEvent("DoLongHudText",source,"Not enough chips!", 2)
                    end
                end
            end
        end
    else
        TriggerClientEvent("DoLongHudText",source,"~r~Error betting!", 2)
    end
end)
                                        ...
                                        while nextCardCount >= 1 do
                                            ...
                                            if blackjackGameData[gameId][source][2][nextCardCount] == true then --if hit 
                                                ...
                                                if currentHand > 21 then
                                                    ...
                                                    TriggerClientEvent("DoLongHudText",source,"you lost "..tostring(lostAmount).." chips", 2)
                                                ...
                                                if dealerHand > 21 then
                                                    ...
                                                    if playerPing ~= nil then
                                                        if playerPing > 0 then
                                                            ...
                                                            TriggerClientEvent("DoLongHudText",source,"~g~+"..tostring(potentialWinAmount).." chips", 2)
                                                ...
                                                elseif currentHand == dealerHand then
                                                    ...
                                                    if playerPing ~= nil then
                                                        if playerPing > 0 then
                                                            ...
                                                            TriggerClientEvent("DoLongHudText",source,"~b~+0 chips", 2)
                                                        end
                                                    end
                                                else
                                                    ...
                                                    if playerPing ~= nil then
                                                        if playerPing > 0 then
                                                            ...
                                                            TriggerClientEvent("DoLongHudText",source,"~r~-"..tostring(potentialPushAmount).." chips", 2)
                                                            if potentialPushAmount > 10000000 then
