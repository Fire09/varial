...
local w = {
	...
	-- wingsuit
	[35] = { ["type"] = 4, "Wingsuit", ["id"] = "wingsuit", ["model"] = 'np_wingsuit_closed', ["z"] = 0.5, ["rx"] = 0.0, ["ry"] = 90.0, ["rz"] = 0.0 },
	[36] = { ["type"] = 4, "Wingsuit", ["id"] = "wingsuitb", ["model"] = 'np_wingsuit_b_closed', ["z"] = 0.5, ["rx"] = 0.0, ["ry"] = 90.0, ["rz"] = 0.0 },
	[36] = { ["type"] = 4, "Wingsuit", ["id"] = "wingsuitc", ["model"] = 'np_wingsuit_b_closed', ["z"] = 0.5, ["rx"] = 0.0, ["ry"] = 90.0, ["rz"] = 0.0 },
}
...
AddEventHandler("AttachWeapons", function()
	...
	DeleteAttached()
	for i = 1, #w do
		if exports["varial-inventory"]:getQuantity(w[i]["id"]) > 0 then
