    ...
    data = {
        {
            ...
            label = "Pickup trash",
            icon = "circle",
            event = "varial-jobs:sanitationWorker:pickupTrash",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            label = "Weights",
            icon = "circle",
            event = "varial-healthcare:exercise",
            parameters = {}
        }
    },
    options = {
...
--             label = "Smoke Machine",
--             icon = "circle",
--             event = "varial-stripclub:smokemachine",
--             parameters = {}
--         }
--     },
--     options = {
  ...
  data = {
      {
          ...
          icon = "chair",
          event = "varial-gopro:activateVRChair",
          parameters = { type = "pd" }
      }
  },
  options = {
  ...
  data = {
      {
          ...
          label = "Check",
          icon = "archive",
          event = "varial-beekeeping:checkBeehive",
          parameters = {}
      }
  },
  options = {
  ...
  data = {
      {
          ...
          event = "varial-beekeeping:harvestHive",
          parameters = {}
      }
  },
  options = {
  ...
  data = {
      {
          ...
          label = "Grab it!",
          icon = "hand-holding",
          event = "varial-heists:grabFromTrolley",
    ...
    data = {
        {
            ...
            label = "Skin Animal",
            icon = "circle",
            event = "varial-hunting:skinAnimal",
            parameters = {}
        }
    },
    options = {
...
--             label = "Whats is THIS?",
--             icon = "circle",
--             event = "varial-zombies:LootTable",
--             parameters = {}
--         }
--     },
--     options = {
