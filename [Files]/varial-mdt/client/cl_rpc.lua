...
RPC.execute = function(name, ...)
    ...
    TriggerServerEvent('varial-remoteCalls:cl_request', res, name, callId, paramPacker(...))
...
RegisterNetEvent('varial-remoteCalls:cl_response')
AddEventHandler('varial-remoteCalls:cl_response', function(origin, callId, response)
