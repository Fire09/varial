...
$(document).ready(() => {
    ...
    $(".profile-items").on("click", ".profile-item", function () {
        let id = $(this).data("id");
        $.post('https://varial-mdt/getProfileData', JSON.stringify({
            id: id
        }));
    })
    $(".profile-items").on("contextmenu", ".profile-item", function (e) {
        if (pJob == 'police' || pJob == 'state' || pJob == 'sheriff') {
            var args = ""
            args = []
    ...
    $(".bulletin-items-continer").on("keydown", ".bulletin-item", function (e) {
        if (e.keyCode === 13) {
            ...
            let time = new Date()
            $.post('https://varial-mdt/newBulletin', JSON.stringify({
                title: title,
                info: info,
                time: time.getTime()
            }));
    ...
    $(".contextmenu").on("click", ".remove-bulletin", function () {
        ...
        $.post('https://varial-mdt/deleteBulletin', JSON.stringify({
            id: BulletinId,
            time: time.getTime()
        }));
        ...
        if (e.keyCode === 13) {
            ...
            if (URL !== "") {
                ...
                setTimeout(() => {
                    ...
                    $.post('https://varial-mdt/addGalleryImg', JSON.stringify({
                        cid: cid,
                        URL: URL
                    }));
                }, 250);
    ...
    $(".manage-profile-save").click(function () {
        if (canSaveProfile == true) {
            ...
            setTimeout(() => {
                ...
                $.post('https://varial-mdt/saveProfile', JSON.stringify({
                    pfp: pfp,
    ...
    $(".manage-incidents-title-holder").on("click", ".manage-incidents-save", function () {
        if (canSaveProfile == true) {
            ...
            $.post('https://varial-mdt/saveIncident', JSON.stringify({
                ID: dbid,
                title: title,
            ...
            setTimeout(() => {
                if (canRefreshIncidents == true) {
                    ...
                    setTimeout(() => {
                        ...
                        $.post('https://varial-mdt/getAllIncidents', JSON.stringify({}));
                    }, 1500);
                }
            }, 1000);
    ...
    $(".contextmenu").on("click", ".search-vehicle", function () {
       ...
       setTimeout(() => {
           ...
           setTimeout(() => {
               ...
               $.post('https://varial-mdt/searchVehicles', JSON.stringify({
                   name: plate.toString()
               }));
               $(".dmv-items").empty();
                $('.dmv-items').prepend(`<div class="profile-loader"></div>`);
               setTimeout(() => {
                   $.post('https://varial-mdt/getVehicleData', JSON.stringify({
    ...
    $(".contextmenu").on("click", ".search-weapon", function () {
        ...
        setTimeout(() => {
            ...
            setTimeout(() => {
                ...
                $.post('https://varial-mdt/searchWeapon', JSON.stringify({
                    name: plate.toString()
                }));
                $(".weapons-items").empty();
                $('.weapons-items').prepend(`<div class="profile-loader"></div>`);
                setTimeout(() => {
                    $.post('https://varial-mdt/getWeaponData', JSON.stringify({
    ...
    $(".contextmenu").on("click", ".revoke-licence", function () {
        if (pJob == 'police' || pJob == 'state' || pJob == 'sheriff') {
            $.post('https://varial-mdt/updateLicence', JSON.stringify({
    ...
    $('#profile-search-input').keydown(function (e) {
        if (e.keyCode === 13 && canSearchForProfiles == true) {
            ...
            if (name !== "") {
                ...
                $.post('https://varial-mdt/searchProfiles', JSON.stringify({
                    name: name
                }));
                $(".profile-items").empty();
    ...
    $('#incidents-search-input').keydown(function (e) {
        if (e.keyCode === 13 && canSearchForProfiles == true) {
            ...
            if (incident !== "") {
                canSearchForProfiles = false
                $.post('https://varial-mdt/searchIncidents', JSON.stringify({
                    incident: incident
                }));
    ...
    $('#dispatchmsg').keydown(function (e) {
        ...
        if (keyCode === 13 && !e.shiftKey) {
            e.preventDefault()
            const time = new Date()
            $.post('https://varial-mdt/dispatchMessage', JSON.stringify({
                message: $(this).val(),
                time: time.getTime()
            }));
            $(this).val("")
    ...
    $(".incidents-items").on("click", ".incidents-item", function () {
        ...
        $.post('https://varial-mdt/getIncidentData', JSON.stringify({
            id: id
        }));
    })
    ...
    document.onkeyup = function (data) {
        if (data.which == 27) {
            ...
            if (shouldClose == true) {
                $.post('https://varial-mdt/escape', JSON.stringify({}));
            }
        }
    };
    ...
    $(".icidents-person-search-name-input").on("keydown", "", function (e) {
        if (e.keyCode === 13) {
            ...
            $.post('https://varial-mdt/incidentSearchPerson', JSON.stringify({
                name: name
            }));
        }
    });
    ...
    $(".manage-bolos-title-holder").on("click", ".manage-bolos-new", function () {
        ...
        //} else {
            var template = "";
            if ($(".badge-logo").attr('src') == 'https://i.imgur.com/B9zsyBj.png') {
    ...
    $(".manage-bolos-title-holder").on("click", ".manage-bolos-save", function () {
        ...
        $.post('https://varial-mdt/newBolo', JSON.stringify({
            existing: existing,
            id: id,
            title: title,
            plate: plate,
    ...
    $('#bolos-search-input').keydown(function (e) {
        if (e.keyCode === 13 && canSearchForProfiles == true) {
            ...
            if (searchVal !== "") {
                canSearchForProfiles = false
                $.post('https://varial-mdt/searchBolos', JSON.stringify({
                    searchVal: searchVal
                }));
                $(".bolos-items").empty();
    ...
    $(".bolos-search-refresh").click(function () {
        if (canRefreshBolo == true) {
            ...
            setTimeout(() => {
                ...
                canRefreshBolo = true
                $.post('https://varial-mdt/getAllBolos', JSON.stringify({}));
            }, 1500);
        }
    });
    ...
    $(".bolos-items").on("click", ".bolo-item", function () {
        ...
        canInputBoloOfficerTag = true
        let id = $(this).data("id");
        $.post('https://varial-mdt/getBoloData', JSON.stringify({
            id: id
        }));
    })
    ...
    $(".contextmenu").on("click", ".bolo-delete", function () { 
        ...
        if ($(this).data("info") != 0) {
            if ($(".badge-logo").attr('src') == 'https://i.imgur.com/B9zsyBj.png') {
                ...
                $.post('https://varial-mdt/deleteICU', JSON.stringify({
                id: $(this).data("info")
            }));
        }
        $(".bolos-items").find("[data-id='" + $(this).data("info") + "']").remove();
        $.post('https://varial-mdt/deleteBolo', JSON.stringify({
            id: $(this).data("info"),
    ...
    $(".contextmenu").on("click", ".incident-delete", function () { 
        ...
        $.post('https://varial-mdt/deleteIncident', JSON.stringify({
            id: $(this).data("info"),
            time: new Date().getTime()
        }));
    });
    ...
    $(".contextmenu").on("click", ".missing-delete", function () { 
        ...
        $.post('https://varial-mdt/deleteMissing', JSON.stringify({
            id: $(this).data("info"),
            time: new Date().getTime()
        }));
    });
    ...
    $(".contextmenu").on("click", ".profile-missing", function () { 
        $.post('https://varial-mdt/missingCitizen', JSON.stringify({
            cid: $(this).data("info"),
    ...
    $(".contextmenu").on("click", ".report-delete", function () { 
        ...
        $.post('https://varial-mdt/deleteReport', JSON.stringify({
            id: $(this).data("info"),
            time: new Date().getTime()
        }));
    });
    ...
    $(".contextmenu").on("click", ".add-charge", function () { 
        ...
        $.post('https://varial-mdt/getPenalCode', JSON.stringify({}));
    });
    ...
    $(".contextmenu").on("click", ".associated-incidents-remove-tag", function () { 
        ...
        if (incidentId != 0) {
            $.post('https://varial-mdt/removeIncidentCriminal', JSON.stringify({
    ...
    $(".contextmenu").on("click", ".incidents-remove-normal-tag", function () { 
        ...
        let cid = $(".manage-profile-citizenid-input").val();
        if (cid) {
            $.post('https://varial-mdt/removeProfileTag', JSON.stringify({
                cid: cid,
                text: $(this).data("info")
            }));
        }
    ...
    $(".reports-search-refresh").click(function () {
        if (canRefreshReports == true) {
            ...
            setTimeout(() => {
                ...
                $.post('https://varial-mdt/getAllReports', JSON.stringify({}));
            }, 1500);
        }
    });
    $(".dispatch-comms-refresh").click(function(){
        ...
        setTimeout(() => {
            ...
            canRefreshReports = true
            $.post('https://varial-mdt/refreshDispatchMsgs', JSON.stringify({}));
        }, 1500);
    })
    $(".reports-items").on("click", ".reports-item", function () {
        ...
        let id = $(this).data("id");
        $.post('https://varial-mdt/getReportData', JSON.stringify({
            id: id
        }));
    })
    ...
    $('#reports-search-input').keydown(function (e) {
        if (e.keyCode === 13 && canSearchForReports == true) {
            ...
            if (name !== "") {
                ...
                $.post('https://varial-mdt/searchReports', JSON.stringify({
                    name: name
                }));
                $(".reports-items").empty();
    ...
    $(".manage-reports-title-holder").on("click", ".manage-reports-save", function () {
        ...
        $.post('https://varial-mdt/newReport', JSON.stringify({
            existing: existing,
            id: id,
            title: title,
            type: type,
    ...
    $('#missing-search-input').keydown(function (e) {
        if (e.keyCode === 13) {
            ...
            if (name !== "") {
                $.post('https://varial-mdt/searchMissing', JSON.stringify({
                    name: name
                }));
                $(".missing-items").empty();
    ...
    $(".missing-items").on("click", ".missing-item", function () {
        $.post('https://varial-mdt/getMissingData', JSON.stringify({
            id: $(this).data("dbid")
        }));
    });
    ...
    $(".vehicle-information-title-holder").on("click", ".vehicle-information-save", function () {
        if (canSaveVehicle) {
            ...
            setTimeout(() => {
                ...
                $.post('https://varial-mdt/saveVehicleInfo', JSON.stringify({
                    dbid: dbid,
                    plate: plate,
                    imageurl: imageurl,
                    notes: notes
    ...
    $(".weapon-information-title-holder").on("click", ".weapon-information-save", function () {
        if (canSaveVehicle) {
            ...
            setTimeout(() => {
                ...
                $.post('https://varial-mdt/saveWeaponInfo', JSON.stringify({
                    dbid: dbid,
    ...
    $(".missing-information-title-holder").on("click", ".missing-information-save", function () {
        if (canSaveVehicle) {
            ...
            setTimeout(() => {
                ...
                $.post('https://varial-mdt/saveMissingInfo', JSON.stringify({
                    id: dbid,
                    imageurl: imageurl,
                    notes: notes
                }));
    ...
    $(".contextmenu").on("click", ".mark-code-5", function () { 
        ...
        if ( tag.hasClass("red-tag")) {
            ...
            $.post('https://varial-mdt/knownInformation', JSON.stringify({
    ...
    $(".contextmenu").on("click", ".set-waypoint", function () { 
        let info = $(this).data("info")
        $.post('https://varial-mdt/setWaypointU', JSON.stringify({
            cid: info,
        }));
    })
    ...
    $(".contextmenu").on("click", ".Set-Waypoint", function () { 
        ...
        $.post('https://varial-mdt/setWaypoint', JSON.stringify({
            callid: callId,
        }));
    })
    ...
    $(".contextmenu").on("click", ".call-attach", function () { 
        const callId = $(this).data("info")
        $.post('https://varial-mdt/callAttach', JSON.stringify({
            callid: callId,
        }));
    })
    ...
    $(".contextmenu").on("click", ".call-detach", function () { 
        const callId = $(this).data("info")
        $.post('https://varial-mdt/callDetach', JSON.stringify({
            callid: callId
        }));
    })
    ...
    $(".contextmenu").on("click", ".remove-call", function () { 
        ...
        $.post('https://varial-mdt/removeCall', JSON.stringify({
            callid: callId
        }));
    })
    ...
    $(".contextmenu").on("click", ".attached-units", function () { 
        const callId = $(this).data("info")
        $.post('https://varial-mdt/attachedUnits', JSON.stringify({
            callid: callId
        }));
    })
    ...
    $('#respondcalls').keydown(function (e) {
        ...
        if (keyCode === 13 && !e.shiftKey) {
            ...
            e.preventDefault();
            const time = new Date()
            $.post('https://varial-mdt/sendCallResponse', JSON.stringify({
                message: $(this).val(),
                time: time.getTime(),
                callid: callid
            }));
    ...
    $(".contextmenu").on("click", ".respond-call", function () {
        const callId = $(this).data("info")
        $.post('https://varial-mdt/getCallResponses', JSON.stringify({
            callid: callId
        }));
    ...
    $(".contextmenu").on("click", ".call-dispatch-detach", function () { 
        const cid = $(this).data("info")
        $.post('https://varial-mdt/callDispatchDetach', JSON.stringify({
    ...
    $(".contextmenu").on("click", ".Set-Dispatch-Waypoint", function () { 
        const cid = $(this).data("info")
        $.post('https://varial-mdt/setDispatchWaypoint', JSON.stringify({
            callid: $(".dispatch-attached-units-container").attr("id"),
            cid: cid
        }));
    })
    ...
    $(".jail-buttons").on("click", ".jail-submit", function () {
        ...
        if (time.length > 0) {
            ...
            $.post('https://varial-mdt/jailPlayer', JSON.stringify({
                cid: cid,
                time: time
            }));
            $(".jail-inner-container").slideUp(500)
    ...
    $(".callsign-buttons").on("click", ".callsign-submit", function () {
        ...
        if (callsign.length > 2) {
            ...
            $.post('https://varial-mdt/setCallsign', JSON.stringify({
                cid: editingcallsign,
    ...
    $(".active-calls-list").on("click", ".active-calls-item", function (e) {
        ...
        if (callId && draggedElement) {
            $.post('https://varial-mdt/callDragAttach', JSON.stringify({
                callid: callId,
                cid: draggedElement
            }));
            draggedElement = 0
    ...
    function JobColors(sentJob) {
        if (sentJob) {
            ...
            if (sentJob == 'state' ) {
                ...
                $(".badge-logo").attr('src','https://i.imgur.com/K4EzI7Y.png');
                ...
                // $(".roster-iframe").attr("src", "https://docs.google.com/spreadsheets/u/2/d/e/2PACX-1vRFY79teZVczLVRFkEKMmiUG79Ae0embLBqFOPbG_ZAl35CYjGgXFEAJ0njuqOfF6LahAXVdFyOZhe7/pubhtml")   
                ...
                document.documentElement.style.setProperty('--color-3', '#426D42');
                document.documentElement.style.setProperty('--color-4', '#808080');
                document.documentElement.style.setProperty('--color-5', '#808080');
                document.documentElement.style.setProperty('--color-6', '#808080');
                document.documentElement.style.setProperty('--color-7', '#3d3d3d');
                document.documentElement.style.setProperty('--color-8', '#808080');
                $(".badge-logo").attr('src','https://i.imgur.com/Z5mDDng.png');
                $(".header-title").html("BLAINE COUNTY SHERIFF DEPARTMENT");
                $(".bolo-nav-item").html("BOLOs");
                $(".bolos-search-title").html("Bolos");                
                $("#bolos-search-input").attr('placeholder','Search Bolo...');
                $(".manage-bolos-title").html("Manage Bolo");
                ...
                document.documentElement.style.setProperty('--color-7', 'rgb(28, 54, 82)');
                document.documentElement.style.setProperty('--color-8', '#2554cc');
                $(".badge-logo").attr('src','https://i.imgur.com/s7zIjgQ.png');
                ...
                $(".badge-logo").attr('src','https://i.imgur.com/B9zsyBj.png');
                ...
                $(".badge-logo").attr('src','https://i.imgur.com/SaMqmtT.png');
    ...
    window.addEventListener('message', function (event) {
        ...
        if (e.type == "show") {
            ...
            $(".manage-profile-job-input").val(table["Workplace"]);
            ...
            $('.licenses-holder').prepend(
                ...
                <div class="license-tag ${driver} driver" data-type="driver">Drivers</div>
                ...
                <div class="license-tag ${bar} bar" data-type="bar">Bar</div>
                <div class="license-tag ${business} business" data-type="business">Business</div>
            `);
            $(".tags-holder").empty();
            $(".vehs-holder").empty();
            ...
            if ((BodyDisplay) == "block") {
                ...
                $.post('https://varial-mdt/dispatchNotif', JSON.stringify({
                    data: value,
                }));
            }
            $('.dispatch-items').scrollTop($('.dispatch-items')[0].scrollHeight)
            ...
            canSearchForProfiles = true
            $(".bolos-items").empty();
            if ($(".badge-logo").attr('src') == 'https://i.imgur.com/B9zsyBj.png') {reportName = "ICU Check-in"}
            $.each(table, function (index, value) {
                if (value.type == "ems") {
                    if ($(".badge-logo").attr('src') == 'https://i.imgur.com/B9zsyBj.png') {
                        $('.bolos-items').prepend(
                ...
                } else if (value.type == "police" || value.type == "state" || value.type == "sheriff") {
                    if ($(".badge-logo").attr('src') == 'https://i.imgur.com/K4EzI7Y.png' || $(".badge-logo").attr('src') == 'https://i.imgur.com/Z5mDDng.png' || $(".badge-logo").attr('src') == 'https://i.imgur.com/s7zIjgQ.png') {
                        $('.bolos-items').prepend(
                            `<div class="bolo-item" data-id="${value.id}">
                            <div class="bolo-top-holder">
                                <div class="bolo-item-title">${value.title}</div>
                ...
                <div class="weapon-item" data-id="${value.id}" data-dbid="${value.id}" data-plate="${value.serial}">
                    ...
                    <div style="display: flex; flex-direction: column;">
                        ...
                        <div class="weapon-bottom-info">
                            <div class="weapon-id">ID: ${value.id} · Owner: ${value.first_name} ${value.last_name}</div>
                        </div>
                    </div>
                </div>
                `)
            ...
            $(".weapon-info-owner-input").val(table["first_name"], table["last_name"]);
        ...
        //     })
            ...
            //     <div class="active-unit-item" data-id="${value.cid}">
            //         <div class="unit-status ${statuscolor}">${status}</div>
            //         <div class="unit-job active-info-job-sahp">SASP</div>
            //         <div class="unit-name">(${callsign}) ${value.name}</div>
            //         <div class="unit-radio">${radio}</div>
            //     </div>
            //     `)
...
function fidgetSpinner(page) {
    ...
    if (page == '.missing-page-container') {
        $.post('https://varial-mdt/getAllMissing', JSON.stringify({}));
    }
    if (page == '.reports-page-container') {
        $.post('https://varial-mdt/getAllReports', JSON.stringify({}));
    }
    if (page == '.stafflogs-page-container') {
        $.post('https://varial-mdt/getAllLogs', JSON.stringify({}));
    }
...
function addTag(tagInput) {
    ...
    $.post('https://varial-mdt/newTag', JSON.stringify({
...
function addWeapon(Input) {
    ...
    $.post('https://varial-mdt/newWeapon', JSON.stringify({
        id: $(".manage-profile-citizenid-input").val(),
        serialnumber: Input
    }));
}
...
function removeImage(url) {
    ...
    $.post('https://varial-mdt/removeGalleryImg', JSON.stringify({
        cid: cid,
        URL: url
    }));
}
