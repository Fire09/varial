...
RegisterNetEvent('varial-remoteCalls:cl_request')
AddEventHandler('varial-remoteCalls:cl_request', function(origin, name, callId, params)
    local response
    local src = source
    ...
    TriggerClientEvent('varial-remoteCalls:cl_response', src, origin, callId, response)
end)