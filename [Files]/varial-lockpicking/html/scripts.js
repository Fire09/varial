  ...
  function outOfPins() {
      $.post('http://varial-lockpicking/failure', JSON.stringify({}));
      gameOver = true;
  ...
  function unlock() {
      $.post('http://varial-lockpicking/complete', JSON.stringify({}));
  ...
  document.onkeyup = function(data) {
      if (data.which == 27) {
          $.post('http://varial-lockpicking/close', JSON.stringify({}));
      }
  };