...
Citizen.CreateThread(function()
    while true do
      ...
      if #toDelete > 0 then
        TriggerServerEvent('Evan:peds:rogue', toDelete)
      end
...
RegisterNetEvent('Evan:peds:rogue:delete')
AddEventHandler('Evan:peds:rogue:delete', function(pNetId)
...
RegisterNetEvent('Evan:peds:decor:set')
AddEventHandler('Evan:peds:decor:set', function (pNetId, pType, pProperty, pValue)
  local entity = NetworkGetEntityFromNetworkId(pNetId)
