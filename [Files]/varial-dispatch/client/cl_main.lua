...
function AlertFight()
    ...
    TriggerServerEvent('varial-dispatch:combatAlert', currentPos)
    if math.random(10) > 5 and not isInVehicle then
        CreateThread(function()
            ...
            if IsPedInAnyVehicle(PlayerPedId()) then
                ...
                TriggerServerEvent('varial-dispatch:combatAlert', newPos)
            end
            return
        end)
    end
...
function AlertGunShot(isHunting, sentWeapon)
    if KnownWeapons[sentWeapon] then
        ...
        TriggerEvent('varial-dispatch:gunshotcl')
        TriggerServerEvent('dispatch:svNotify', {
...
RegisterNetEvent('varial-mdt:drugsale')
AddEventHandler("varial-mdt:drugsale",function()
    DrugSale()
end)
...
function DrugSale()
    ...
    TriggerServerEvent('varial-dispatch:drugsale', currentPos)
    TriggerServerEvent('dispatch:svNotify', {
        dispatchCode = initialTenCode,
        firstStreet = locationInfo,
        pin = Pin,
    ...
    if math.random(10) > 5 and not isInVehicle then
        CreateThread(function()
            ...
            if IsPedInAnyVehicle(PlayerPedId()) then
                ...
                TriggerServerEvent('varial-dispatch:drugsale', newPos)
            end
            return
        end)
    end
...
function CarCrash()
    ...
    TriggerServerEvent('varial-dispatch:vehiclecrash', currentPos)
    TriggerServerEvent('dispatch:svNotify', {
        dispatchCode = dispatchCode,
        firstStreet = locationInfo,
        pin = Pin,
...
function AlertCheckLockpick(object)
    ...
    TriggerEvent('varial-dispatch:stolenveh')
    TriggerServerEvent('dispatch:svNotify', {
        dispatchCode = initialTenCode,
        firstStreet = locationInfo,
        pin = Pin,
...
RegisterNetEvent('varial-dispatch:houserobbery')
AddEventHandler("varial-dispatch:houserobbery",function()
    AlertHouseRobbery()
end)
...
function AlertHouseRobbery()
    ...
    TriggerEvent('varial-dispatch:robhouse')
    TriggerServerEvent('dispatch:svNotify', {
        dispatchCode = dispatchCode,
        firstStreet = locationInfo,
        pin = Pin,
...
function AlertJewelRob()
    ...
    TriggerServerEvent('varial-dispatch:jewel', currentPos)
    TriggerServerEvent('dispatch:svNotify', {
        dispatchCode = dispatchCode,
        firstStreet = locationInfo,
        pin = Pin,
    ...
    if math.random(10) > 2 and not isInVehicle then
        CreateThread(function()
            ...
            if IsPedInAnyVehicle(PlayerPedId()) then
                ...
                TriggerServerEvent('varial-dispatch:jewel', newPos)
            end
            return
        end)
    end
...
function AlertJailBreak()
    ...
    TriggerServerEvent('varial-dispatch:blip:jailbreak', currentPos)
    TriggerServerEvent('dispatch:svNotify', {
        dispatchCode = dispatchCode,
        firstStreet = locationInfo,
        pin = Pin,
    ...
    if math.random(10) > 2 and not isInVehicle then
        CreateThread(function()
            ...
            if IsPedInAnyVehicle(PlayerPedId()) then
                ...
                TriggerServerEvent('varial-dispatch:blip:jailbreak', newPos)
            end
            return
        end)
    end
...
function AlertFleecaRobbery()
    ...
    local currentVeh = GetVehiclePedIsIn(PlayerPedId(), false)
    local dispatchCode = "10-90"
    TriggerServerEvent('varial-dispatch:bankwobbewy', currentPos)
    TriggerServerEvent('dispatch:svNotify', {
        dispatchCode = dispatchCode,
        firstStreet = locationInfo,
        pin = Pin,
    ...
    if math.random(10) > 2 and not isInVehicle then
        CreateThread(function()
            ...
            if IsPedInAnyVehicle(PlayerPedId()) then
                ...
                TriggerServerEvent('varial-dispatch:bankwobbewy', newPos)
            end
            return
        end)
    end
...
RegisterNetEvent('varial-dispatch:bankrobbery')
AddEventHandler("varial-dispatch:bankrobbery",function()
    AlertFleecaRobbery()
end)

RegisterNetEvent('varial-dispatch:bankrobbery:pacific')
AddEventHandler("varial-dispatch:bankrobbery:pacific",function()
    AlertPacificRobbery()
end)
...
RegisterNetEvent("varial-dispatch:boostTrackerPing")
AddEventHandler("varial-dispatch:boostTrackerPing", function(toggle)
    if toggle == true then
  ...
  TriggerEvent("varial-dispatch:carBoostTracker")
...
function AlertDeath()
    ...
    TriggerEvent('varial-dispatch:downguy')
    TriggerServerEvent('dispatch:svNotify', {
        dispatchCode = dispatchCode,
        firstStreet = locationInfo,
        pin = Pin,
...
RegisterNetEvent('varial-dispatch:jewelrobbery')
AddEventHandler("varial-dispatch:jewelrobbery",function()
    AlertJewelRob()
end)

RegisterNetEvent('varial-dispatch:carjacking')
AddEventHandler("varial-dispatch:carjacking",function()
    AlertCheckLockpick()
end)
...
LoadEvanVersion = function()
    ...
    RegisterNetEvent('varial-dispatch:setBlip')
    AddEventHandler('varial-dispatch:setBlip', function(type, pos, id)
        ...
        for i,v in ipairs(gasStations) do
            ...
            if scandst < 20 and scandst < dstcheck then
                ...
                if IsExplosionInSphere(9,v[1],v[2],v[3],60.0)  then
                    ...
                    TriggerEvent('varial-dispatch:gasexplosion')
                    Wait(9000)
                    origin3 = false
                end
            end
...
RegisterNetEvent('varial-dispatch:storerobbery2')
AddEventHandler("varial-dispatch:storerobbery2",function()
    AlertShop()
end)
...
function AlertShop()
    ...
    TriggerEvent('varial-dispatch:robstore')
    TriggerServerEvent('dispatch:svNotify', {
        dispatchCode = dispatchCode,
        firstStreet = locationInfo,
        pin = Pin,
...
RegisterNetEvent('varial-dispatch:bank_truck_robbery')
AddEventHandler("varial-dispatch:bank_truck_robbery",function()
    AlertBankTruck()
end)
...
function AlertBankTruck()
    ...
    local currentVeh = GetVehiclePedIsIn(PlayerPedId(), false)
    local dispatchCode = "10-90"
    TriggerEvent('varial-dispatch:bankt')
    TriggerServerEvent('dispatch:svNotify', {
        dispatchCode = dispatchCode,
        firstStreet = locationInfo,
        pin = Pin,
...
RegisterNetEvent('varial-dispatch:bobcat_robbery')
AddEventHandler("varial-dispatch:bobcat_robbery",function()
    AlertBobcat()
end)
...
function AlertBobcat()
    ...
    local currentVeh = GetVehiclePedIsIn(PlayerPedId(), false)
    local dispatchCode = "10-90"
    TriggerEvent('varial-dispatch:dispatchBobcat')
    TriggerServerEvent('dispatch:svNotify', {
        dispatchCode = dispatchCode,
        firstStreet = locationInfo,
        pin = Pin,
...
RegisterNetEvent('varial-boosting:ping')
AddEventHandler('varial-boosting:ping', function()
    AlertBoosting()
end)
...
RegisterNetEvent('varial-dispatch:unauthorised_aircraft')
AddEventHandler("varial-dispatch:unauthorised_aircraft",function()
    Aircraft()
end)
...
function Aircraft()
    ...
    local currentVeh = GetVehiclePedIsIn(PlayerPedId(), false)
    local dispatchCode = "10-31A"
    TriggerEvent('varial-dispatch:cocaine_plane')
    TriggerServerEvent('dispatch:svNotify', {
        dispatchCode = dispatchCode,
        firstStreet = locationInfo,
        pin = Pin,
