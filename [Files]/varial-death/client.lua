...
RegisterNetEvent('varial-death:deathCheck')
AddEventHandler('varial-death:deathCheck', function()
...
AddEventHandler('disableAllActions', function()
    if not disablingloop then
        ...
        TriggerEvent("varial-death:deathCheck")
...
AddEventHandler('disableAllActions2', function()
    ...
    while isPlayerDead == 1 do
        ...
        if IsControlJustPressed(1,29) then
            ...
            Citizen.Wait(22000)
            TriggerEvent("varial-death:forceAnim")
        end
...
RegisterNetEvent('varial-death:revive')
AddEventHandler('varial-death:revive', function()
    attemptRevive()
end)
...
function releaseBody()
    ...
    TriggerEvent('varial-phone:fix-dead')
