...
RegisterNetEvent('varial-lib:cl_request')
AddEventHandler('varial-lib:cl_request', function(origin, name, callId, params)
    local response
    local src = source
    ...
    TriggerClientEvent('varial-lib:cl_response', src, origin, callId, response)
end)