...
RPC.execute = function(name, ...)
    ...
    TriggerServerEvent('varial-rpc:cl_request', res, name, callId, paramPacker(...))
...
RegisterNetEvent('varial-rpc:cl_response')
AddEventHandler('varial-rpc:cl_response', function(origin, callId, response)
