...
RPC.execute = function(name, ...)
    ...
    TriggerServerEvent('varial-lib:cl_request', res, name, callId, paramPacker(...))
...
RegisterNetEvent('varial-lib:cl_response')
AddEventHandler('varial-lib:cl_response', function(origin, callId, response)
