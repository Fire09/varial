...
RegisterNetEvent("varial-scoreboard:RemovePlayer")
AddEventHandler("varial-scoreboard:RemovePlayer", function(data)
    Void.Scoreboard:RemovePlayer(data)
end)

RegisterNetEvent("varial-scoreboard:AddPlayer")
AddEventHandler("varial-scoreboard:AddPlayer", function(data)
    Void.Scoreboard:AddPlayer(data)
end)

RegisterNetEvent("varial-scoreboard:RemoveRecent")
AddEventHandler("varial-scoreboard:RemoveRecent", function(src)
    Void.Scoreboard:RemoveRecent(src)
end)

RegisterNetEvent("varial-scoreboard:AddAllPlayers")
AddEventHandler("varial-scoreboard:AddAllPlayers", function(data)
