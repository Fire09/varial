	...
	while true do
		...
		for k,v in pairs (pedList) do
			...
			if dist < 20.0 and hasAlreadyEntered == false then
				TriggerEvent('varial-peds:nearPed', v.model, v.coords, v.heading, v.gender, v.animDict, v.animName)
...
AddEventHandler('varial-peds:nearPed', function(model, coords, heading, gender, animDict, animName)
	RequestModel(model)
...
Config.PedList = {
...

	{
		...
		coords = vector3(990.77, 30.90, 71.46),
		heading = 60.1, 
		gender = "female", 
		animName = "WORLD_HEN_STANDINGT",
	},
--[[ 	{
		model = "csb_tomcasino",
		coords = vector3(990.77, 30.90, 71.46),
