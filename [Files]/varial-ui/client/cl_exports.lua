...
RegisterNetEvent("varial-ui:open-application")
AddEventHandler("varial-ui:open-application", openApplication)
...
function closeApplication(app, data)
    ...
    TriggerEvent("varial-ui:application-closed", app, { fromEscape = false })
end
