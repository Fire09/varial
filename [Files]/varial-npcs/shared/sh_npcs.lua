...
Generic.ShopKeeperLocations = {
  ...
  vector4(24.81, -1347.88, 28.5, 281.56),
  ...
  vector4(812.68, -783.61, 25.17, 292.97)
}
...
Generic.CasinoLocations2 = {
  vector4(988.90, 43.27, 70.28, 201.73), -- wheel of fortune
  vector4(978.4, 25.39, 70.48, 43.67), -- drinks bar
}

Generic.PoliceVehicles = {
  vector4(464.51, -1012.686, 27.08, 176.1), -- Normal PD Cars + Persuit
}

Generic.PoliceVehicles2 = {
  vector4(464.4556, -1021.247, 27.10533, 359.616), -- SWAT
}

Generic.Farming = {
  vector4(2564.66, 4680.08, 33.08, 47.54), -- Farming
}
