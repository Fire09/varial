...
Config['General'] = {
    ...
    ["Core"] = "NPBASE", -- This can be ESX , QBCORE , NPBASE
    ["SQLWrapper"] = "oxmysql", -- This can be `| oxmysql or ghmattimysql or mysql-async
    ["EmailEvent"] = "phone:addnotification",
...
Config['CoreSettings'] = {
    ...
    ["NPBASE"] = {
        ["Name"] = "varial-base", -- this will be used in server side to call player module
        ["ProgressBarScriptName"] = "varial-taskbar", -- progress bar script name link in np_readme.md
        ["HasItem"] = "varial-inventory", -- Imporant [ Your normal export for checking has item, default is yourservername:inventory ] 
        ["HandlerScriptName"] = "isPed",
    }
}
...
Config['Utils'] = {
    ["Rewards"] = {
        ["Type"] = "item", -- reward type item or money
        ["RewardItemName"] = "cashstack", -- this will be the reward item name (no need to config if you are using an money as a reward)
    ...
    ["Contracts"] = {
        ["TimeBetweenContracts"] = math.random(900000, 1300000), -- Time in (ms) between contract creations
        ["ContractChance"] = 80, -- This is the luck percentage of getting a contract
    },
    ["VIN"] = {
        ["BNEPrice"] = 1000, -- Price (BNE) for start a vin scratch
    ...
    ["Notifications"] = {
        ...
        ["TrackerRemoved"] = "Tracker removed", 
        ["FinishComputer"] = "Scratch the VIN at the front of the windshield!",
        ["VehicleAdded"] = "Vehicle added to your garage!",
        ["DropOffMsg"] = "Get out of the car and leave the area , you will get your money soon", 
        ["UiStillLoadingMsg"] = "Please wait 5 seconds the laptop is loading", 
        ["SuccessHack"] = "Success" ,
        ...
        ["AlreadyStarted"] = "A mission is already started",
...
Config.Vehicles = {
    ...
    ---------- X CLASS --------------
    [1] = {vehicle = "t20", class = "X"},
    [2] = {vehicle = "Zion2", class = "X"},
    [3] = {vehicle = "Felon", class = "X"},
    [4] = {vehicle = "Zentorno", class = "X"},
    -- ---------- A CLASS --------------
    [5] = {vehicle = "Oracle2", class = "A"},
    [6] = {vehicle = "Windsor2", class = "A"},
    [7] = {vehicle = "SabreGT2", class = "A"},
    [8] = {vehicle = "Sentinel2", class = "A"},
    [9] = {vehicle = "Zion", class = "A"},
    [10] = {vehicle = "Phoenix", class = "A"},
    [11] = {vehicle = "Washington", class = "A"},
    [12] = {vehicle = "Banshee2", class = "A"},
    [13] = {vehicle = "Infernus2", class = "A"},
    [14] = {vehicle = "Nero", class = "A"},
    [15] = {vehicle = "Nero2", class = "A"},
    [16] = {vehicle = "Brawler", class = "A"},
    ---------- B CLASS --------------
    [17] = {vehicle = "Prairie", class = "B"},
    [18] = {vehicle = "Chino", class = "B"},
    [19] = {vehicle = "Dukes", class = "B"},
    [20] = {vehicle = "Virgo3", class = "B"},
    [21] = {vehicle = "Tampa", class = "B"},
    [22] = {vehicle = "Blade", class = "B"},
    [23] = {vehicle = "Nightshade", class = "B"},
    [24] = {vehicle = "Primo", class = "B"},
    [25] = {vehicle = "Primo2", class = "B"},
    [26] = {vehicle = "Regina", class = "B"},
    [27] = {vehicle = "ZType", class = "B"},
    [28] = {vehicle = "Bison3", class = "B"},
    [29] = {vehicle = "Bison", class = "B"},
    [30] = {vehicle = "blista", class = "B"},
    [31] = {vehicle = "blista2", class = "B"},
    [32] = {vehicle = "Issi2", class = "B"},
    [33] = {vehicle = "Issi2", class = "B"},
    [34] = {vehicle = "Buccaneer2", class = "B"},
    [35] = {vehicle = "Picador", class = "B"},
    ---------- C CLASS --------------
    [36] = {vehicle = "Emperor2", class = "C"},
    [37] = {vehicle = "Tornado3", class = "C"},
    [38] = {vehicle = "BType", class = "C"},
    [39] = {vehicle = "Sadler", class = "C"},
    [40] = {vehicle = "Bison2", class = "C"},
    [41] = {vehicle = "Minivan2", class = "C"},
    [42] = {vehicle = "RatLoader", class = "C"},
    [43] = {vehicle = "Virgo2", class = "C"},
    ---------- D CLASS --------------
    [44] = {vehicle = "Dilettante", class = "D"},
    [45] = {vehicle = "Emperor", class = "D"},
    [46] = {vehicle = "Glendale", class = "D"},
    [47] = {vehicle = "Tailgater", class = "D"},
    [48] = {vehicle = "Baller", class = "D"},
    [49] = {vehicle = "Patriot", class = "D"},
    [50] = {vehicle = "BobcatXL", class = "D"},
    [51] = {vehicle = "Manana", class = "D"},
    [52] = {vehicle = "Burrito", class = "D"},
    [53] = {vehicle = "Granger", class = "D"},
