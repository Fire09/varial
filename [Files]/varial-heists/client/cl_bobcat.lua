...
RegisterNetEvent('varial-bobcat:firstdoor')
    AddEventHandler('varial-bobcat:firstdoor', function()
        local player = GetEntityCoords(PlayerPedId())
        local distance = #(vector3(882.17254638672, -2258.0190429688, 32.461284637451) - player)
        if distance < 1.5 then
            if exports["varial-duty"]:LawAmount() >= 4 then
                if exports["varial-inventory"]:hasEnoughOfItem("thermitecharge", 1) then
                    frontdoor()
                    FreezeEntityPosition(PlayerPedId(), true)
                    local bobcat = exports["varial-taskbar"]:taskBar(9000, "Attempting Hack!")
                    if bobcat == 100 then
                        FreezeEntityPosition(PlayerPedId(), false)
                        exports['varial-thermite']:OpenThermiteGame(function(success)
                            if success then
                                TriggerEvent("inventory:removeItem", "thermitecharge", 1)
                                TriggerServerEvent('varial-doors:change-lock-state', 2, false) 
                                TriggerServerEvent("varial-doors:change-lock-state", 3, false)
                                TriggerEvent('varial-dispatch:bobcat_robbery')
                                Citizen.Wait(3000) 
...
RegisterNetEvent('varial-bobcat:seconddoor')
AddEventHandler('varial-bobcat:seconddoor', function()
    local player = GetEntityCoords(PlayerPedId())
    local distance = #(vector3(880.89782714844, -2263.880859375, 32.441692352295) - player)
    if distance < 1.5 then
        if exports["varial-duty"]:LawAmount() >= 4 then
                if exports["varial-inventory"]:hasEnoughOfItem("Gruppe6Card2", 1, false) and exports["varial-inventory"]:hasEnoughOfItem("thermitecharge", 1) then
                        insidedoor()
                        FreezeEntityPosition(PlayerPedId(), true)
                        local bobcat = exports["varial-taskbar"]:taskBar(9000, "Attempting Hack!")
                        if bobcat == 100 then
                            ...
                            exports["memorygame"]:thermiteminigame(10, 3, 3, 10,
                                function()
                                    ...
                                    TriggerEvent("inventory:removeItem", "thermitecharge", 1)
                                    --Door IDS
                                    TriggerServerEvent("varial-doors:change-lock-state", 1, false)
                                    TriggerEvent('varial-dispatch:bobcat_robbery')
                                    Citizen.Wait(3000)
                                end, 
                                function ()
...
function frontdoor() -- FRONT DOOR ANIMATION
    RequestAnimDict("anim@heists@ornate_bank@thermitecharge")
    RequestModel("hei_p_m_bag_var22_arm_s")
    RequestNamedPtfxAsset("scr_ornate_heist")
    while not HasAnimDictLoaded("anim@heists@ornate_bank@thermitecharge") and not HasModelLoaded("hei_p_m_bag_var22_arm_s") and not HasNamedPtfxAssetLoaded("scr_ornate_heist") do
        Citizen.Wait(50)
    end
    ...
    NetworkAddPedToSynchronisedScene(ped, bagscene, "anim@heists@ornate_bank@thermitecharge", "thermitecharge", 1.2, -4.0, 1, 16, 1148846080, 0)
    NetworkAddEntityToSynchronisedScene(bag, bagscene, "anim@heists@ornate_bank@thermitecharge", "bag_thermitecharge", 4.0, -8.0, 1)
    ...
    TaskPlayAnim(ped, "anim@heists@ornate_bank@thermitecharge", "cover_eyes_intro", 8.0, 8.0, 1000, 36, 1, 0, 0, 0)
    TaskPlayAnim(ped, "anim@heists@ornate_bank@thermitecharge", "cover_eyes_loop", 8.0, 8.0, 3000, 49, 1, 0, 0, 0)
    Citizen.Wait(5000)
    ClearPedTasks(ped)
    DeleteObject(bomba)
...
RegisterNetEvent("bobcat:success:panel", function()
    TriggerEvent('DoLongHudText', "Success!", 1)
    TriggerServerEvent("varial-doors:change-lock-state", 160, false)
    TriggerServerEvent("varial-doors:change-lock-state", 161, false)
    TriggerEvent('varial-dispatch:bobcat_robbery')
end)
...
RegisterNetEvent("bobcat2:success:panel", function()
    TriggerEvent('DoLongHudText', "Success!", 1)
    TriggerServerEvent("varial-doors:change-lock-state", 162, false)
    TriggerEvent('varial-dispatch:bobcat_robbery')
end)
...
RegisterNetEvent('varial-bobcat:bubbles')
...
AddEventHandler('lumo:client:requestblast', function()
	TriggerServerEvent("varial-bobcat:request_door")
end)
...
AddEventHandler('lumo:pedbomb', function()
    ...
    TriggerServerEvent("varial-bobcat:bubbles")
    TriggerEvent("lumo:propcreate")
    Wait(1500)
...
RegisterNetEvent('varial-bobcat:search_crate_1unchecked') -- PED WALK
AddEventHandler('varial-bobcat:search_crate_1unchecked', function()
    TriggerServerEvent("varial-bobcat:search_crate_1")
end)

RegisterNetEvent('varial-bobcat:search_crate_2unchecked') -- PED WALK
AddEventHandler('varial-bobcat:search_crate_2unchecked', function()
    TriggerServerEvent("varial-bobcat:search_crate_2")
end)

RegisterNetEvent('varial-bobcat:search_crate_3unchecked') -- PED WALK
AddEventHandler('varial-bobcat:search_crate_3unchecked', function()
    TriggerServerEvent("varial-bobcat:search_crate_3")
end)

RegisterNetEvent('varial-bobcat:search_crate_1') 
AddEventHandler('varial-bobcat:search_crate_1', function()
    FreezeEntityPosition(GetPlayerPed(-1),true)
    TriggerEvent("doAnim","search")
    TriggerEvent('varial-dispatch:bobcat_robbery')
    local finished = exports["varial-taskbar"]:taskBar(30000,"Looting")
    if finished == 100 then
        TriggerEvent('varial-heists:bobcat_loot')
...
RegisterNetEvent('varial-bobcat:search_crate_2') 
...
RegisterNetEvent('varial-bobcat:search_crate_3')
...
RegisterNetEvent('varial-heists:bobcat_loot')
AddEventHandler('varial-heists:bobcat_loot', function()
