...
AddEventHandler('spawn:clientSpawnData', function(spawnData)
		...
		if spawnData.overwrites ~= nil then
			...
			elseif spawnData.overwrites == "new" then
				...
				-- TriggerEvent("varial-spawn:firstspawnyo")
			end
			return
		end
...
RegisterNetEvent("varial-spawn:firstspawnyo")
AddEventHandler("varial-spawn:firstspawnyo", function()
    if GetEntityModel(PlayerPedId()) == GetHashKey("mp_f_freemode_01") then
        TriggerEvent("varial-spawn:finishedClothingstuffbish")
    else
        TriggerEvent("varial-spawn:finishedClothingstuff")
    end
end)

RegisterNetEvent('varial-spawn:finishedClothingstuff')
AddEventHandler('varial-spawn:finishedClothingstuff', function()
...
RegisterNetEvent('varial-spawn:finishedClothingstuffbish')
AddEventHandler('varial-spawn:finishedClothingstuffbish', function()
