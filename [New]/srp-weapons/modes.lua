...
Citizen.CreateThread(function()
	...
	exports["varial-keybinds"]:registerKeyMapping("", "Weapons", "Switch Weapon Mode", "+switchWeaponMode", "-switchWeaponMode")
=======
	exports["varial-keybinds"]:registerKeyMapping("", "Weapons", "Switch Weapon Mode", "+switchWeaponMode", "-switchWeaponMode")
...
function SwitchWeaponMode()
	...
	if ForceWeaponMode[pWeaponHash] ~= nil then
		if SELECTED_FIRE_RATE == ForceWeaponMode[pWeaponHash] then
			...
			TriggerEvent("varial-weapons:client:setWeaponFireRate", 33.3 * SELECTED_FIRE_RATE)
=======
			TriggerEvent("varial-weapons:client:setWeaponFireRate", 33.3 * SELECTED_FIRE_RATE)
...
RegisterNetEvent("varial-weapons:client:weaponEquiped")
AddEventHandler("varial-weapons:client:weaponEquiped", function(pWeaponHash, newInformation, sqlID, itemToRemove, pArmed)
	if ForceWeaponMode[pWeaponHash] ~= nil then
		SELECTED_FIRE_RATE = ForceWeaponMode[pWeaponHash]
		TriggerEvent("varial-weapons:client:setWeaponFireRate", 33.3 * SELECTED_FIRE_RATE)
=======
...
AddEventHandler("varial-weapons:client:weaponEquiped", function(pWeaponHash, newInformation, sqlID, itemToRemove, pArmed)
	...
	TriggerEvent("varial-weapons:client:showWeaponFireRate", pArmed)
	TriggerEvent("varial-weapons:client:setWeaponFireRate", 33.3 * SELECTED_FIRE_RATE)
=======
	TriggerEvent("varial-weapons:client:showWeaponFireRate", pArmed)
	TriggerEvent("varial-weapons:client:setWeaponFireRate", 33.3 * SELECTED_FIRE_RATE)
