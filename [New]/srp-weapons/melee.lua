...
CreateThread(function()
  ...
  while true do
    ...
    if RecentlyRiding then
      ...
      local BikeArmor = exports["varial-inventory"]:hasEnoughOfItem("bikearmor", 1, false,true)
=======
      local BikeArmor = exports["varial-inventory"]:hasEnoughOfItem("bikearmor", 1, false,true)
...
function ProcessHitByCash(pAttacker)
  ...
  TriggerServerEvent("varial-weapons:attackedByCash", pAttacker)
=======
  TriggerServerEvent("varial-weapons:attackedByCash", pAttacker)
...
AddEventHandler("DamageEvents:EntityDamaged", function(victim, attacker, pWeapon, isMelee)
  ...
  if ( (pWeapon == CrashHash or pWeapon == RamHash or pWeapon == FallHash) and exports["varial-inventory"]:hasEnoughOfItem("bikearmor", 1, false, true) and not DegApplied and RecentlyRiding) then
=======
  if ( (pWeapon == CrashHash or pWeapon == RamHash or pWeapon == FallHash) and exports["varial-inventory"]:hasEnoughOfItem("bikearmor", 1, false, true) and not DegApplied and RecentlyRiding) then
