...
RegisterNetEvent('varial-items:SetAmmo')
AddEventHandler('varial-items:SetAmmo', function(sentammoTable)
=======
RegisterNetEvent('varial-items:SetAmmo')
AddEventHandler('varial-items:SetAmmo', function(sentammoTable)
...
Citizen.CreateThread(function()
	...
	exports["varial-keybinds"]:registerKeyMapping("", "Player", "Action Bar", "+actionBar", "-actionBar", "TAB")
	RegisterCommand('+actionBar', actionBarDown, false)
	RegisterCommand('-actionBar', actionBarUp, false)

	exports["varial-keybinds"]:registerKeyMapping("", "Player", "Wink", "+playerWink", "-playerWink")
	RegisterCommand('+playerWink', playerWink, false)
	RegisterCommand('-playerWink', function() end, false)

	exports["varial-keybinds"]:registerKeyMapping("", "Player", "Passive Mode", "+passiveMode", "-passiveMode")
=======
	exports["varial-keybinds"]:registerKeyMapping("", "Player", "Action Bar", "+actionBar", "-actionBar", "TAB")
	RegisterCommand('+actionBar', actionBarDown, false)
	RegisterCommand('-actionBar', actionBarUp, false)
...
AddEventHandler('varial-actionbar:hotreload', function()
=======
AddEventHandler('varial-actionbar:hotreload', function()
...
Citizen.CreateThread( function()
	...
	while true do
      ...
      if weapon == "-37975472" then
        ...
        TriggerEvent("varial-weapons:threwSmokeGrenade")
        if lastEquippedItemToRemove then
          if exports["varial-inventory"]:hasEnoughOfItem(lastEquippedItemToRemove,1,false) then
=======
        TriggerEvent("varial-weapons:threwSmokeGrenade")
        if lastEquippedItemToRemove then
          if exports["varial-inventory"]:hasEnoughOfItem(lastEquippedItemToRemove,1,false) then
...
=======
        ...
        lastEquippedItemToRemove = nil
			...
			if throwableWeapons[weapon] and exports["varial-inventory"]:hasEnoughOfItem(weapon,1,false) then
=======
			if throwableWeapons[weapon] and exports["varial-inventory"]:hasEnoughOfItem(weapon,1,false) then
...
=======
		...
		if IsPedPlantingBomb(ped) then
			...
			if exports["varial-inventory"]:hasEnoughOfItem("741814745",1,false) then
=======
			if exports["varial-inventory"]:hasEnoughOfItem("741814745",1,false) then
...
AddEventHandler("varial-voice:focus:set", function(pState)
=======
AddEventHandler("varial-voice:focus:set", function(pState)
...
AddEventHandler('equipWeaponID', function(hash,newInformation,sqlID,itemToRemove)
	...
	if not exports["varial-propattach"]:canPullWeaponHoldingEntity() then return end
=======
	if not exports["varial-propattach"]:canPullWeaponHoldingEntity() then return end
...
=======
  ...
  lastEquippedItemToRemove = itemToRemove
	...
	TriggerEvent("varial-weapons:client:weaponEquiped", hash, newInformation, sqlID, itemToRemove, armed)
=======
	TriggerEvent("varial-weapons:client:weaponEquiped", hash, newInformation, sqlID, itemToRemove, armed)
...
function updateAmmoTable(newammo,ammoType)
	...
	TriggerServerEvent("varial-weapons:updateAmmo",newammo,ammoType,ammoTable)
=======
	TriggerServerEvent("varial-weapons:updateAmmo",newammo,ammoType,ammoTable)
...
RegisterNetEvent('varial-item:CheckClientAmmo')
AddEventHandler('varial-item:CheckClientAmmo', function(weapons)
=======
RegisterNetEvent('varial-item:CheckClientAmmo')
AddEventHandler('varial-item:CheckClientAmmo', function(weapons)
...
function AttachmentCheck(weaponhash)
	...
	if exports["varial-inventory"]:hasEnoughOfItem("weapon_silencer_assault", 1, false, true) then
=======
	if exports["varial-inventory"]:hasEnoughOfItem("weapon_silencer_assault", 1, false, true) then
...
=======
	...
	if exports["varial-inventory"]:hasEnoughOfItem("weapon_silencer_pistol", 1, false, true) then
=======
	if exports["varial-inventory"]:hasEnoughOfItem("weapon_silencer_pistol", 1, false, true) then
...
=======
	...
	if exports["varial-inventory"]:hasEnoughOfItem("weapon_oil_silencer", 1, false, true) then
		GiveWeaponComponentToPed( PlayerPedId(), weaponhash, 1532150734 )
	end

	if exports["varial-inventory"]:hasEnoughOfItem("weapon_scope", 1, false, true) then
=======
	if exports["varial-inventory"]:hasEnoughOfItem("weapon_oil_silencer", 1, false, true) then
		GiveWeaponComponentToPed( PlayerPedId(), weaponhash, 1532150734 )
	end
...
=======
	...
	if exports["varial-inventory"]:hasEnoughOfItem("weapon_uzi_extended", 1, false, true) then
		GiveWeaponComponentToPed( PlayerPedId(), weaponhash, 0xE40F1CD2 )	
	end
	if exports["varial-inventory"]:hasEnoughOfItem("weapon_uzi_foldstock", 1, false, true) then
		GiveWeaponComponentToPed( PlayerPedId(), weaponhash, 0x8FBBD54C )		
	end
	if exports["varial-inventory"]:hasEnoughOfItem("weapon_uzi_woodstock", 1, false, true) then
=======
	if exports["varial-inventory"]:hasEnoughOfItem("weapon_uzi_extended", 1, false, true) then
		GiveWeaponComponentToPed( PlayerPedId(), weaponhash, 0xE40F1CD2 )	
	end
...
RegisterNetEvent("varial-weapons:hitPlayerWithCash", function(pTarget)
  TriggerServerEvent("Varial-weapons:processGiveCashAmount", pTarget, lastEquippedInfo.amount, lastEquippedInfo.id)
=======
RegisterNetEvent("varial-weapons:hitPlayerWithCash", function(pTarget)
  TriggerServerEvent("varial-weapons:processGiveCashAmount", pTarget, lastEquippedInfo.amount, lastEquippedInfo.id)
