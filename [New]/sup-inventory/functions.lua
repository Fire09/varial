...
local function processStressBlock()
    ...
    TriggerEvent("varial-buffs:applyBuff", "joints", { { buff = "stressblock", percent = 1.0 } })
end
...
AddEventHandler("varial-katana:removeEquippedKatana", function()
=======
    TriggerEvent("varial-buffs:applyBuff", "joints", { { buff = "stressblock", percent = 1.0 } })
end
...
RegisterCommand('+useKeyFob', function()
    ...
    if Throttled("varial-doorss:doorKeyFob", 1000) then return end
...
Citizen.CreateThread(function()
    ...
    exports["varial-keybinds"]:registerKeyMapping("", "Vehicle", "Door Keyfob", "+useKeyFob", "-useKeyFob", "Y")
=======
    exports["varial-keybinds"]:registerKeyMapping("", "Vehicle", "Door Keyfob", "+useKeyFob", "-useKeyFob", "Y")
          ...
          if tonumber(ItemInfo.quality) > 0 then
              if not isKatanaEquipped then
                ...
                Citizen.CreateThread(function()
                    ...
                    TriggerServerEvent("varial-katana:cursedKatanaEquip", GetEntityCoords(PlayerPedId()))
                    TriggerEvent("varial-katana:cursedKatanaEquipC")
=======
                    TriggerServerEvent("varial-katana:cursedKatanaEquip", GetEntityCoords(PlayerPedId()))
                    TriggerEvent("varial-katana:cursedKatanaEquipC")
...
=======
    ...
    if stolenItems[itemid] and exports["varial-npcs"]:isCloseToPawnPed() then
=======
    if stolenItems[itemid] and exports["varial-npcs"]:isCloseToPawnPed() then
...
=======
    ...
    if (itemid == "pdbadge") then
        ...
        RPC.execute("varial-gov:police:showBadge", json.decode(ItemInfo.information))
=======
        RPC.execute("varial-gov:police:showBadge", json.decode(ItemInfo.information))
...
=======
        ...
        if (finished == 100) then
            ...
            TriggerEvent(
              ...
              itemid == "customjointitem" and 1.5 or 0.75
            )
            remove = true
        end
    end
...
=======
    ...
    if (itemid == "flamethrowerammo") then
        ...
        local finished = exports["varial-taskbar"]:taskBar(20000,"Reloading flamethrower",false,false,playerVeh)
=======
        local finished = exports["varial-taskbar"]:taskBar(20000,"Reloading flamethrower",false,false,playerVeh)
...
=======
    ...
    if (itemid == "huntingammo") then
        ...
        local finished = exports["varial-taskbar"]:taskBar(10000,"Reloading",false,false,playerVeh)
=======
        local finished = exports["varial-taskbar"]:taskBar(10000,"Reloading",false,false,playerVeh)
...
=======
    ...
    if (itemid == "rpgammo") then
        ...
        local finished = exports["varial-taskbar"]:taskBar(25000,"Reloading",false,false,playerVeh)
=======
        local finished = exports["varial-taskbar"]:taskBar(25000,"Reloading",false,false,playerVeh)
...
=======
    ...
    if (itemid == "armor" or itemid == "pdarmor") then
        ...
        local finished = exports["varial-taskbar"]:taskBar(5000,"Armor",true,false,playerVeh)
=======
        local finished = exports["varial-taskbar"]:taskBar(5000,"Armor",true,false,playerVeh)
...
=======
    ...
    if (itemid == "newaccountbox") then
        ...
        local finished = exports["varial-taskbar"]:taskBar(5000,"Opening present",false,false,playerVeh)
=======
        local finished = exports["varial-taskbar"]:taskBar(5000,"Opening present",false,false,playerVeh)
...
=======
    ...
    if (itemid == "housesafe") then
        if not hasEnoughOfItem("heavydutydrill", 1, false) then
            ...
            local finished = exports["varial-taskbar"]:taskBar(30000, "Cracking Safe...", true, false)
=======
            local finished = exports["varial-taskbar"]:taskBar(30000, "Cracking Safe...", true, false)
...
=======
    ...
    if (itemid == "fishingchest") then
        ...
        local finished = exports["varial-taskbar"]:taskBar(5000, "Opening Chest", true, false)
=======
        local finished = exports["varial-taskbar"]:taskBar(5000, "Opening Chest", true, false)
...
=======
    ...
    if (itemid == "repcrate") then
        ...
        local finished = exports["varial-taskbar"]:taskBar(30000, "Opening...", true, false)
=======
        local finished = exports["varial-taskbar"]:taskBar(30000, "Opening...", true, false)
...
=======
    ...
    if (itemid == "babyoil") then
        ...
        local finished = exports["varial-taskbar"]:taskBar(10000,"Applying baby oil to dome",true,false,playerVeh)
=======
        local finished = exports["varial-taskbar"]:taskBar(10000,"Applying baby oil to dome",true,false,playerVeh)
...
=======
    ...
    if (itemid == "emptyballoon") then
        if (hasEnoughOfItem("nitrous",1,false)) then
            ...
            local finished = exports["varial-taskbar"]:taskBar(5000,"Filling Balloon.",false,false,playerVeh)
=======
            local finished = exports["varial-taskbar"]:taskBar(5000,"Filling Balloon.",false,false,playerVeh)
...
=======
    ...
    if (itemid == "Peecup_empty") then
        ...
        local finished = exports["varial-taskbar"]:taskBar(10000, "Peeing in cup.", false, false, playerVeh)
=======
        local finished = exports["varial-taskbar"]:taskBar(10000, "Peeing in cup.", false, false, playerVeh)
...
=======
    ...
    if (itemid == "megaphone") then
      ...
      TriggerEvent("varial-usableprops:megaphone")
=======
      TriggerEvent("varial-usableprops:megaphone")
...
=======
            ...
            finished = exports["varial-taskbar"]:taskBar(20000,"Nitrous")
=======
            finished = exports["varial-taskbar"]:taskBar(20000,"Nitrous")
...
=======
    ...
    if (itemid == "ciggy") then
        ...
        local finished = exports["varial-taskbar"]:taskBar(1000,"Lighting Up",false,false,playerVeh)
=======
        local finished = exports["varial-taskbar"]:taskBar(1000,"Lighting Up",false,false,playerVeh)
...
=======
    ...
    or itemid == "experiment_09") then
        ...
        local finished = exports["varial-taskbar"]:taskBar(3000,"Downing content of bottle. 💊",false,false,playerVeh)
=======
        local finished = exports["varial-taskbar"]:taskBar(3000,"Downing content of bottle. 💊",false,false,playerVeh)
...
=======
    ...
    if (itemid == "pillbox") then
        ...
        local finished = exports["varial-taskbar"]:taskBar(5000, "Opening pill box", false, false, playerVeh)
=======
        local finished = exports["varial-taskbar"]:taskBar(5000, "Opening pill box", false, false, playerVeh)
...
=======
    ...
    if itemid == "kdragonwater" then
        ...
        AttachPropAndPlayAnimation(
          ...
          "varial-katana:transformKFromDrink",
=======
          "varial-katana:transformKFromDrink",
...
=======
        ...
        finished = exports["varial-taskbar"]:taskBar(20000,"Harness")
=======
        finished = exports["varial-taskbar"]:taskBar(20000,"Harness")
...
=======
    ...
    if itemid == "roostertea" then
        ...
        AttachPropAndPlayAnimation("amb@world_human_drinking@coffee@male@idle_a", "idle_c", 49,15000,"Drink","varial-roostersrest:drinkTea",true,itemid,playerVeh)
=======
        AttachPropAndPlayAnimation("amb@world_human_drinking@coffee@male@idle_a", "idle_c", 49,15000,"Drink","varial-roostersrest:drinkTea",true,itemid,playerVeh)
...
=======
    ...
    if itemid == "franksflute" then
      ...
      TriggerServerEvent("varial-inventory:franksFlute", GetEntityCoords(PlayerPedId()))
=======
      TriggerServerEvent("varial-inventory:franksFlute", GetEntityCoords(PlayerPedId()))
...
=======
    ...
    if itemid == "tattooremover" then
        ...
        if IsEntityAPed(target) and IsPedAPlayer(target) then
            ...
            local finished = exports["varial-taskbar"]:taskBar(60000, "Removing tattoos")
=======
            local finished = exports["varial-taskbar"]:taskBar(60000, "Removing tattoos")
...
=======
    ...
    if itemid == "buddhaletter" then
        if GetEntityModel(PlayerPedId()) == `ig_buddha` or GetEntityModel(PlayerPedId()) == `g_m_m_buddha` then
            ...
            local finished = exports["varial-taskbar"]:taskBar(5000,"Opening letter.",false,false,playerVeh)
=======
            local finished = exports["varial-taskbar"]:taskBar(5000,"Opening letter.",false,false,playerVeh)
        ...
        if hasEnoughOfItem("buddhablade",1,false) and hasEnoughOfItem("buddhaguard",1,false) and hasEnoughOfItem("buddhahilt",1,false) then
            if hasEnoughOfItem("buddhamedalion",1,false) then
                ...
                if #(playerPos - vector3(-172.54, 319.13, 87.35)) < 10 then
                    ...
                    local finished = exports["varial-taskbar"]:taskBar(30000,"Putting sword together.",false,false,playerVeh)
=======
                    local finished = exports["varial-taskbar"]:taskBar(30000,"Putting sword together.",false,false,playerVeh)
    ...
    if itemid == "buddhashovel" then
        ...
        if #(playerPos - vector3(-1911.78, 1388.1, 219.35)) < 10 then
            if BuddhaIsItemFound1 == false then
                ...
                local finished = exports["varial-taskbar"]:taskBar(15000, "Digging for something.", false, true, false, false, nil, 5.0, PlayerPedId())
=======
                local finished = exports["varial-taskbar"]:taskBar(15000, "Digging for something.", false, true, false, false, nil, 5.0, PlayerPedId())
...
=======
    ...
    TriggerEvent("varial-inventory:itemUsed", itemid, passedItemInfo, inventoryName, slot)
    TriggerServerEvent("varial-inventory:itemUsed", itemid, passedItemInfo, inventoryName, slot)
=======
    TriggerEvent("varial-inventory:itemUsed", itemid, passedItemInfo, inventoryName, slot)
    TriggerServerEvent("varial-inventory:itemUsed", itemid, passedItemInfo, inventoryName, slot)
...
AddEventHandler("varial-inventory:attachPropPlayAnim", function(pType)
=======
AddEventHandler("varial-inventory:attachPropPlayAnim", function(pType)
...
AddEventHandler('np-business:repairItem', function()
    ...
    local itemListInfo = json.decode(exports["varial-inventory"]:itemListInfo(info.item_id))
=======
    local itemListInfo = json.decode(exports["varial-inventory"]:itemListInfo(info.item_id))
...
function checkForItems()
    ...
    for _, item in ipairs(items) do
        ...
        if hasItem and not PreviousItemCheck[item] then
            ...
            TriggerEvent('varial-inventory:itemCheck', item, true, quantity)
        elseif not hasItem and PreviousItemCheck[item] then
            PreviousItemCheck[item] = false
            TriggerEvent('varial-inventory:itemCheck', item, false, quantity)
=======
            TriggerEvent('varial-inventory:itemCheck', item, true, quantity)
        elseif not hasItem and PreviousItemCheck[item] then
            PreviousItemCheck[item] = false
    ...
    if targetVehicle == 0 then
        ...
        if driverPed ~= 0 and (IsPedAPlayer(driverPed) or not IsPedDeadOrDying(driverPed)) then
            ...
            if result.success and not isForced then
                ...
                exports['varial-flags']:SetVehicleFlag(targetVehicle, 'isStolenVehicle', true)
=======
                exports['varial-flags']:SetVehicleFlag(targetVehicle, 'isStolenVehicle', true)
...
=======
        ...
        if targetVehicle ~= 0 then
            ...
            if exports["varial-vehicles"]:HasVehicleKey(targetVehicle) then lockpicking = false return end
=======
            if exports["varial-vehicles"]:HasVehicleKey(targetVehicle) then lockpicking = false return end
...
function getInformationFromFirstItem(itemToFind)
  ...
  local foundItem = exports["varial-inventory"]:GetInfoForFirstItemOfName(itemToFind)
=======
  local foundItem = exports["varial-inventory"]:GetInfoForFirstItemOfName(itemToFind)
...
RegisterUICallback("np-ui:inv:moneycaseAction", function(data, cb)
  ...
  RPC.execute("varial-inventory:doMoneycaseAction", data)
end)

AddEventHandler("varial-inventory:openGolfStore", function(name, info)
=======
  RPC.execute("varial-inventory:doMoneycaseAction", data)
end)
...
AddEventHandler("ammonium_bicarbonate:insert", function(pOriginInventory, pTargetInventory, pOriginSlot, pTargetSlot, pOriginItemId, pTargetItemId, pOriginItemInfo, pTargetItemInfo)
    ...
    local finished = exports["varial-taskbar"]:taskBar(5000 * quantity, "Breaking down into baggies...", false, false)
=======
    local finished = exports["varial-taskbar"]:taskBar(5000 * quantity, "Breaking down into baggies...", false, false)
