...
function getQuantity(pServerId, pItemId)
    ...
    local user, amount = exports["varial-base"]:getModule("Player"):GetUser(pServerId), 0
=======
    local user, amount = exports["varial-base"]:getModule("Player"):GetUser(pServerId), 0
...
=======
    ...
    if user then
        ...
        if checkQuality then
            ...
            decayDate = exports['varial-inventory']:GetDecayDate(pItemId)
=======
            decayDate = exports['varial-inventory']:GetDecayDate(pItemId)
...
function removeItem(pServerId, pItemId, pAmount, pShouldNotify)
    ...
    local user = exports["varial-base"]:getModule("Player"):GetUser(pServerId)
=======
    local user = exports["varial-base"]:getModule("Player"):GetUser(pServerId)
