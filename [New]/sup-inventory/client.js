...
on('varial-base:playerSpawned', (broughtData) => {
=======
RegisterNetEvent('varial-base:playerSpawned')
on('varial-base:playerSpawned', (broughtData) => {
...
RegisterNetEvent('varial-base:update:settings')
on('varial-base:update:settings', (data) => {
=======
RegisterNetEvent('varial-base:update:settings')
on('varial-base:update:settings', (data) => {
...
on('__cfx_nui:UpdateSettings', (data, cb) => {
    ...
    emitNet("varial-inventory:update:settings", data)
=======
    emitNet("varial-inventory:update:settings", data)
...
let itemListWithTax = async() => {
    ...
    // console.log(await RPC.execute("GetTaxLevel", "Goods"));
