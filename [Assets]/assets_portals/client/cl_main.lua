...
AddEventHandler('meth:exit', function()
	...
	Citizen.Wait(100)
	TriggerEvent('InteractSound_CL:PlayOnOne', 'DoorOpen', 0.8)
	SetEntityCoords(PlayerPedId(),  -255.94285583496, -1542.7252197266, 31.908447265625)
	SetEntityHeading(PlayerPedId(), 229.60629272461)
	DoScreenFadeIn(1000)
	Citizen.Wait(1000)
...
AddEventHandler("guncraft:exit", function ()
	...
	TriggerEvent("dooranim")
	TriggerEvent('InteractSound_CL:PlayOnOne', 'DoorOpen', 0.8)
	SetEntityCoords(PlayerPedId(), 1181.8768310547, -3113.7421875, 6.0281920433044)
	SetEntityHeading(PlayerPedId(), 92.65892791748)
	DoScreenFadeIn(1000)
	Citizen.Wait(1000)
end)
...
AddEventHandler("coke:exit", function ()
	...
	TriggerEvent("dooranim")
	TriggerEvent('InteractSound_CL:PlayOnOne', 'DoorOpen', 0.8)
	SetEntityCoords(PlayerPedId(), 980.71282958984, -1705.7885742188, 31.117658615112)
	SetEntityHeading(PlayerPedId(), 86.260063171387)
	DoScreenFadeIn(1000)
	Citizen.Wait(1000)
...
RegisterNetEvent('Casino:Outdoors') -- hotel from indoors to out
AddEventHandler('Casino:Outdoors', function()
	FreezeEntityPosition(PlayerPedId(),true)
	TriggerEvent("DoLongHudText","Enjoying Elevator Music!",1)
	local finished = exports["varial-taskbar"]:taskBar(5500,"Elevator")
		if finished == 100 then
		DoScreenFadeOut(1)
		Citizen.Wait(100)
		TriggerEvent('InteractSound_CL:PlayOnOne', 'elevator', 0.8)
		SetEntityCoords(PlayerPedId(), 987.52209472656, 79.483825683594, 80.990562438965)
		DoScreenFadeIn(1000)
		FreezeEntityPosition(PlayerPedId(),false)
		Citizen.Wait(1000)
		end
	end)
RegisterNetEvent('Casino:Indoors') -- hotel from outdoors to in
AddEventHandler('Casino:Indoors', function()
	FreezeEntityPosition(PlayerPedId(),true)
	TriggerEvent("DoLongHudText","Enjoying Elevator Music!",1)
	local finished = exports["varial-taskbar"]:taskBar(5500,"Elevator")
		if finished == 100 then
		...
		Citizen.Wait(100)
		TriggerEvent('InteractSound_CL:PlayOnOne', 'elevator', 0.8)
		SetEntityCoords(PlayerPedId(),  914.00213623047, -54.700180053711, 21.000099182129)
		DoScreenFadeIn(1000)
		FreezeEntityPosition(PlayerPedId(),false)
		Citizen.Wait(1000)
		end
	...
	RegisterNetEvent('Casino:HotelUpstairs') -- hotel from downstairs to hotel
	AddEventHandler('Casino:HotelUpstairs', function()
		FreezeEntityPosition(PlayerPedId(),true)
		TriggerEvent("DoLongHudText","Enjoying Elevator Music!",1)
		local finished = exports["varial-taskbar"]:taskBar(5500,"Elevator")
			if finished == 100 then
			...
			Citizen.Wait(100)
			TriggerEvent('InteractSound_CL:PlayOnOne', 'elevator', 0.8)
			SetEntityCoords(PlayerPedId(),  910.61022949219, -52.661602020264, 21.000104904175)
			DoScreenFadeIn(1000)
			FreezeEntityPosition(PlayerPedId(),false)
			Citizen.Wait(1000)
			end
		...
		RegisterNetEvent('Casino:HotelDownstairs') -- hotel from downstairs to hotel
	AddEventHandler('Casino:HotelDownstairs', function()
		FreezeEntityPosition(PlayerPedId(),true)
		TriggerEvent("DoLongHudText","Enjoying Elevator Music!",1)
		local finished = exports["varial-taskbar"]:taskBar(5500,"Elevator")
			if finished == 100 then
			...
			Citizen.Wait(100)
			TriggerEvent('InteractSound_CL:PlayOnOne', 'elevator', 0.8)
			SetEntityCoords(PlayerPedId(),  959.92498779297, 43.369300842285, 71.700942993164)
			DoScreenFadeIn(1000)
			FreezeEntityPosition(PlayerPedId(),false)
			Citizen.Wait(1000)
			end
